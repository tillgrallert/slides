...
![Zielbild von NFDI4Memory](../../assets/dh/4memory/zielbild_klein.jpg){#fig:zielbild}
...
![Poster "The World's Writing Systems". [Quelle](https://www.worldswritingsystems.org/poster.php)](../../assets/dh/twws-poster-22-960.jpg){#fig:poster-wws-1}

::::
:::: column

Affordancen der Digitalität und epistemische Gewalt von Infrastrukturen

Geschriebene Sprache als Mensch-Maschine Schnittstelle

Wie kann eine Datenkultur in den Geisteswissenschaften aussehen?
...
- in 2025 hat sich der Stromverbrauch gegenüber dem Vorjahr um ein Drittel erhöht
- zwischen 2022 und 2025 hat er sich verdoppelt
- der Stromverbrauch war so groß, wie der von Neuseeland (5.3 Mio Menschen) oder Marokko (26,8 Mio Menschen)

- >The company’s total electricity consumption jumped from 31 terawatt hours (TWh) in 2024 to 43 TWh in 2025. This is very easily the biggest increase in their electricity consumption ever, and it puts them way ahead of Microsoft.
...
Constructing the other, the one being spoken about but not talked to. The other, that is unspeakable and who cannot be understood

- Spivak: can the subaltern speak? yes, but we cannot hear or understand them
    - epistemische Gewalt der Trennung zwischen sprechendem Subjekt und gesprochenen Objekt (also sujet oder subject)
    - Setzt auf Marx und die Dualität von Darstellen und Vertreten in Repräsentieren
- Orwell, Klemperer: New Speak: language devoid of meaning and semantics
    - easy to think off LLMs in this regard
...
![Setzkasten. John, CC BY-SA 3.0, via [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Upperandlowercase.jpg)](https://upload.wikimedia.org/wikipedia/commons/thumb/6/69/Upperandlowercase.jpg/960px-Upperandlowercase.jpg)
...
- JSON
    - es liegt an der Standardeinstellung `ensure_ascii=True`
    - dazu Spezifikationen von JSON [@JSON22017] und Mastodon Thread als Quelle
...
| Sprache   | Shots  | Thinking | f1               | Time  |
| --------- | -----: | :------  | -----------:     | ----: |
| de        | 0      | F        | [0.1584]{.red}   | 0.4   |
| en        | 0      | F        | 0.6485           | 0.46  |
| de        | 0      | T        | 0.7894           | 7:26  |
| en        | 0      | T        | 0.8197           | 7:09  |
| de        | 32     | F        | [0.1584]{.red}   | 0:39  |
| en        | 32     | F        | 0.7905           | 0:59  |
| de        | 32     | T        | [0.8273]{.green} | 7:14  |
| en        | 32     | T        | 0.8307           | 8:22  |
...
- Daten aus unseren Tests von LLM für NER auf einem Corpus von deutsch-sprachigen Baedeker Reiseführeren für Berlin.
    - deutschsprachige Prompts performen signifikant schlechter als englischsprachige
    - Verbesserung mit "thinking" ist durch die Übersetzung des Prompts ins Englische durch das LLM im ersten Schritt des "thinking" bedingt
...
# Drei Prinzipien <br/>DIY, but not alone, and KISS
...
![Mitglieder des [IZ Digitalität und digitale Methoden][iz2d]](../../assets/dh/website_iz-digitalität.png){#fig:website-iz}
...
### nurture people and communities
...
- Wir müssen uns selbst ermächtigen, Blackboxes öffnen und die Grundlagen der Digitalität verstehen!
- Wer, wenn nicht wir, kümmert sich um die Dinge, die uns wichtig sind?
...
- die Mitglieder der AG Digitalität im [Interdisziplinären Zentrum Digitalität und Digitale Methoden am Campus Mitte (IZ2D)][iz2d] der [HU Berlin]: Torsten Hiltmann, Eliza Mandieva, Roland Meyer, Shintaro Miyazaki, Caroline Odebrecht, Lars Erik Zeige 
- die Kolleg_innen der [Task Area *Data Culture*][ta5] von [NFDI4Memory]: Nicole Dresselhaus, Torsten Hiltmann, Marie von Lüneburg, Christiane Weber

## Literatur {#refs}

<!-- links -->
[AG Multilingual DH]: https://digitalhumanities.de/ag-multilingual-dh/
[DHd]: https://digitalhumanities.de/
[HU Berlin]: https://hu-berlin.de
[iz2d]: https://izd2m.hu-berlin.de/
[NFDI4Memory]: https://4memory.de
[ta5]: https://4memory.de/ueber-4memory/task-areas/data-culture/